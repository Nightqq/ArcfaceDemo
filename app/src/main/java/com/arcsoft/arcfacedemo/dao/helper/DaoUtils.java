...
import com.arcsoft.arcfacedemo.dao.DaoMaster;
import com.arcsoft.arcfacedemo.dao.DaoSession;
...
public class DaoUtils {
    ...
    private static void setDatabase(Context context) {
        ...
        DaoMaster.DevOpenHelper mHelper = new DaoMaster.DevOpenHelper(context, "zxdz-card-db", null);
